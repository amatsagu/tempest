...
var _ RestHandler = (*BaseRestHandler)(nil)
...
func NewBaseRestHandler(token string) RestHandler {
	t := token
...
func (rest *BaseRestHandler) Request(method string, route string, jsonPayload interface{}) ([]byte, error) {
	var body io.Reader
	if jsonPayload != nil {
...
func (rest *BaseRestHandler) Token() string {
	return rest.token
}

func (rest *BaseRestHandler) handleRequest(method string, route string, payload io.Reader, contentType string) ([]byte, error, bool) {
